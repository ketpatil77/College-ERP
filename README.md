...
[![Stars](https://img.shields.io/github/stars/ketpatil77/College-ERP?style=for-the-badge&logo=github)](https://github.com/ketpatil77/College-ERP)
...
| Role | Email | Password |
|------|-------|----------|
| **Admin** | `ket.patil77@gmail.com` | `Ket@2003` |
| **Student** | `kp12321232@gmail.com` | `Ket@2003` |
...
- ✅ [Python 3.11](https://www.python.org/downloads/) - Programming language
...
DEFAULT_FROM_EMAIL=College ERP <your-email@example.com>
```

For local demo logins, copy `local_credentials.example.json` to `local_credentials.json` and change the sample credentials. The real `local_credentials.json` file is ignored by Git.
...
[![GitHub](https://img.shields.io/badge/GitHub-Follow-black?style=for-the-badge&logo=github)](https://github.com/ketpatil77)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue?style=for-the-badge&logo=linkedin)](https://www.linkedin.com/in/ketpatil77)
...
- 🐛 **Issues:** [GitHub Issues](https://github.com/ketpatil77/College-ERP/issues)
- 💬 **Discussions:** [GitHub Discussions](https://github.com/ketpatil77/College-ERP/discussions)
...
[![Star History Chart](https://api.star-history.com/svg?repos=ketpatil77/College-ERP&type=Date)](https://star-history.com/#ketpatil77/College-ERP&Date)

**Maintained by [Ket Patil](https://github.com/ketpatil77)**
